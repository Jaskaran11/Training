class CrudNotificationMailer < ApplicationMailer
  ...
  def update_notification(object)
    ...
    mail to: 'jaskaran@gmail.com', subject: "A new entry for #{object.class} has been updated"
  end
  ...
  def delete_notification(object)
    ...
    mail to: 'jaskaran@gmail.com', subject: "A new entry for #{object.class} has been deleted"
  end
end
